            ...
            void UpdateNodeView(NodeType selectedType)
            {
                ...
                switch (selectedType)
                {
                    case NodeType.NoType:
                        dynamicContent.Add(new NoTypeView());
                        break;
                    case NodeType.Start:
                        dynamicContent.Add(new StartView());
                        break;
                    case NodeType.End:
                        dynamicContent.Add(new EndView());
                        break;
                    case NodeType.Random:
                        dynamicContent.Add(new RandomView());
                        break;
                    case NodeType.MultipleChoice:
                        dynamicContent.Add(new MultipleChoiceView());
                        break;
                    case NodeType.Reminder:
                        dynamicContent.Add(new ReminderView());
                        break;
                    case NodeType.Timeout:
                        dynamicContent.Add(new TimeoutView());
                        break;
                    case NodeType.Dialogue:
                        dynamicContent.Add(new DialogueView());
                        break;
                }
            }
